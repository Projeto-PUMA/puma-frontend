...
const SidebarContent = props => {
  ...
  admLinks.push(<Link to='/submeternoticia' key="submeternoticia" style={styles.sidebarLink}><img className="img-responsive" src={news} alt="news" style={{ height: 25, marginRight: 7, marginTop: -2 }} />Submeter Notícia</Link>);
